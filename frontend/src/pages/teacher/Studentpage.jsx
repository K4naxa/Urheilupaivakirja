...
function StudentPage() {
  ...
  const {
    ...
    queryFn: () => trainingService.getUserJournalEntriesByUserId(id),
    staleTime: 15 * 60 * 1000, // = 15 minutes in milliseconds - how long to use the cached data before re-fetching
  });

  useEffect(() => {
    console.log(
      "StudentJournalData fetched successfully: ",
      studentJournalData
    );
  }, [isSuccess, studentJournalData]);
  ...
  return (
    <div className="mainArea overflow-x-auto">
      <div className="text-xl ">Student Information here</div>
      <div
